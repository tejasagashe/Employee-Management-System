    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            String designation = tfdesignation.getText();
             ...
             try {
                Conn conn = new Conn();
                String query = "update  employee set lname='"+lname+"',salary='"+salary+"', address='"+address+"', phone='"+phone+"', email='"+email+"',education= '"+education+"',designation= '"+designation+"' where employeeid='"+empId+"'";
